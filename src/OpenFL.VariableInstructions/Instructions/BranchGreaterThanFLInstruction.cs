...
{
    public class BranchGreaterThanFLInstruction : JumpFLInstruction
    {

        public BranchGreaterThanFLInstruction(List<FLInstructionArgument> arguments) : base(2, arguments)
        {
        }
